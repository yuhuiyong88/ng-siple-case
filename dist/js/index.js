...
var CitySetDate = exports.CitySetDate = function () {
    function CitySetDate(checkInDate, checkOutDate) {
        _classCallCheck(this, CitySetDate);
    ...
    _createClass(CitySetDate, [{
        ...
        key: "setOutDate",
        value: function setOutDate() {
            var checkOut_date = new Date(this.cYear + "/" + this.cMonth + "/" + (this.cDay + 1));
            var outYear = checkOut_date.getFullYear();
            var outMonth = checkOut_date.getMonth() + 1;
            var outDay = checkOut_date.getDate();
...
var City = exports.City = function () {
    ...
    _createClass(City, [{
        ...
        key: "hotCity",
        value: function hotCity() {
            var hotCityEle = "<div class=\"title_common\">\u70ED\u95E8</div><ul class=\"hot_list\">";
            for (var i in this.opt.hotList) {
        ...
        key: "collecCityHeight",
        value: function collecCityHeight() {
        ...
        value: function bindEvent() {
            ...
            this.cityPlugin.addEventListener("click", function (e) {
                ...
                if (target.tagName == "SPAN") {
                    _this.cityPlugin.scrollTop = 12222;
                    _this.cityPlugin.scrollTop = _this.heightInfo[target.getAttribute("alpha")];
                    console.log(_this.heightInfo[target.getAttribute("alpha")]);
                }
...
var _cityDate = __webpack_require__(3);
...
//跳转到list页面
function toList() {
    var indexSubmit = document.querySelector(".index_submit");
    var dateLiveIn = document.querySelector(".in_data").innerHTML;
    var dateLeave = document.querySelector(".out_data").innerHTML;
    var checkInCity = document.querySelector(".check_in").innerHTML;
...
function rendenBanner() {
    var _ref = [document.querySelector(".banner_list"), ""],
        banner = _ref[0],
        str = _ref[1];
    ...
    (0, _toops.ajax)({
        ...
        callback: function callback(data) {
            ...
            new _swiper.Swiper(".swiper-container", {
                autoplay: 1000,
                loop: true
            });
        }
...
function getLocation() {
    ...
    location.onclick = function () {
        ...
        if (glt) {
            //watchLocation
            glt.getCurrentPosition(function (value) {
                //success
                //精度
                ...
                (0, _toops.jsonp)('http://apis.map.qq.com/ws/location/v1/ip?key=7SFBZ-SLNRP-UTZDY-VMH2X-NQG5T-D3FRF&output=jsonp', function (data) {
                    console.log(data);
                });
            }, {
...
function hotListCity(city_data, Hot_list) {
    var city_module = void 0;
    var checkInHotel = document.querySelector(".check_in_hotel");
    city_data.then(function (data) {
        city_module = new _select.City({
            data: data,
            hotList: Hot_list,
...
function setTime() {
    var checkInDate = document.querySelector(".check_in_data .in_data");
    var checkOutDate = document.querySelector(".check_out_hotel .out_data");
    new _cityDate.CitySetDate(checkInDate, checkOutDate);
    renderDate(checkInDate, checkOutDate);
}

function renderDate(checkInDate, checkOutDate) {
    var calender_module = void 0;
    calender_module = new _calendar.Calendar({
        "initDate": new Date()
    });
    checkInDate.onclick = function () {
        calender_module.show(checkInDate);
    };
    checkOutDate.onclick = function () {
