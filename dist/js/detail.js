...
function atlasImg() {
    ...
    var describeList = document.querySelector(".describe_list");
        ...
        (0, _toops.ajax)({
            ...
            callback: function callback(date) {
                ...
                setTimeout(function () {
                    ...
                    new _swiper.Swiper(describeList, {});
                }, 100);
            }
        });
    };
...
function setTime() {
    ...
    checkIn.innerHTML = (0, _toops.getParams)("dateLeave");
    checkLeave.innerHTML = (0, _toops.getParams)("dateLiveIn");
...
function getId() {
    var hotelId = (0, _toops.getParams)("id");
    var detailHotel = document.querySelector(".detail_hotel");
    var rigths = document.querySelector(".rigths");
    var detailStr = "";
    var rightStr = "";
    (0, _toops.ajax)({
        url: "../../data/hotel.json",
...
function reserve() {
    var reserveHotel = document.querySelectorAll(".reserve_hotel");
    var ReserveMark = document.querySelector(".Reserve_mark");

    var _loop = function _loop(k) {
        reserveHotel[k].onclick = function () {
            var clickReserve = reserveHotel[k].parentNode.querySelectorAll(".click_reserve span");
            var orderMsg = document.querySelector(".order_msg");
            var infoStr = "";
    ...
    for (var k = 0; k < reserveHotel.length; k++) {
        _loop(k);
    }
...
function toggleInfo() {
    var Linfo = document.querySelector(".l_info");
    var Rinfo = document.querySelector(".r_info");
    var detailNav = document.querySelector(".detail_nav");
    var rights = document.querySelector("#toggleRigths");
    detailNav.addEventListener("click", function (e) {
        var target = e.target;
...
function toWrite() {
    ...
    var ReserveMark = document.querySelector(".Reserve_mark");
    var ReserveFoot = document.querySelector(".Reserve_foot");
    ...
    ReserveFoot.onclick = function () {
        var orderMsg = document.querySelectorAll(".order_msg span");
        ReserveMark.className = "Reserve_mark";
